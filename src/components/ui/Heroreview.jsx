...
export default function Heroreview (){
    return(
      ...
      <div className="banner-image absolute top-0 left-0 w-full h-full bg-cover bg-center opacity-50" style={{ backgroundImage: "url('/images/about-banner.png')" }}></div>
          ...
          <div className="law-hero-area flex items-center justify-between hero-about">
            <div className="law-hero-info max-w-[650px] xl:max-w-[850px]">
              <div className="law-hero__content">
                <h1 className="tracking-wider law-hero__content-title mb-5 font-bold" data-aos="fade-up" data-aos-duration="2000">Client's Review</h1>
                <p className="mb-50">
