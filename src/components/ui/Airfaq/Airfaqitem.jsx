export default function Airfaqitem ({
    question,
    answer
}){
    return (
        <div className="accordion-slide group faq-slide bg-[#f2f2f2] text-color p-5 mb-5" itemScope="" itemProp="mainEntity" itemType="https://schema.org/Question">
