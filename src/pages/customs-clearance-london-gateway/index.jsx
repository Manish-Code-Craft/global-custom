...
export default function Services({preview}){
  ...
  const liverpoolFeatures = [
    { 
      ...
      desc: "We prioritise speed and precision to keep your cargo moving and avoid quay rent or demurrage.", 
      icon: <Clock size={24} /> 
    },
    { 
    ...
    { 
      title: "Daily Operations at London Gateway", 
      desc: "We work closely with carriers, port operators, and hauliers at London Gateway, ensuring seamless communication and efficient clearance.", 
      icon: <Ship size={24} /> 
    },
    { 
  ...
  const whyPortItems = [
    ...
    return(
        ...
        <Heroservice
          title="Customs Clearance at London Gateway Port"         
          backgroundImage="/images/service-bg.jpg"
          desc={[
            "Fast, Accurate & Fully Compliant UK Customs Services",           
            "Shipping through DP World London Gateway demands a customs partner who understands the port’s digital systems, operational flow, and carrier requirements. We provide fast, reliable, and fully compliant customs clearance for importers, exporters, freight forwarders, and hauliers using London Gateway — one of the UK’s most advanced deep‑sea ports.",           
            "From containerised cargo to specialist freight, we ensure your goods clear customs smoothly, without delays, errors, or unexpected charges.",           
          ]} 
          />
        ...
        <section className="py-24 bg-[#049fe1] relative overflow-hidden isolate">
          ...
          <div className="mxl:max-w-[1400px] 2xl:max-w-[1500px] mx-auto px-6 relative z-10">
            <div className="mb-12">
              <h2 className="text-4xl font-bold text-white mb-4">Why Choose Us for Customs Clearance at London Gateway?</h2>
            </div>
      ...
      <section className="py-24 bg-slate-50">
        <div className="mxl:max-w-[1400px] 2xl:max-w-[1500px] mx-auto px-6">
          <div className="text-center mb-16">
            ...
            <h2 className="text-3xl md:text-5xl font-bold text-slate-900 mt-6">Our Customs Services at London Gateway Port</h2>
          </div>
      ...
      <section className="py-20 bg-white border-y border-slate-100">
        <div className="mxl:max-w-[1400px] 2xl:max-w-[1500px] mx-auto px-6 text-center">
            ...
            <p className="text-slate-500 mb-12 text-lg max-w-2xl mx-auto">We work with a wide range of sectors shipping through London Gateway, including:</p>
         ...
         <div className="mxl:max-w-[1400px] 2xl:max-w-[1500px] mx-auto px-6 relative z-10">
            <div className="flex flex-col md:flex-row items-center justify-between mb-16 gap-8">
              <div className="md:w-1/2">
                ...
                <h3 className="text-4xl md:text-5xl font-bold text-white mb-6 leading-tight">Why <span className="text-[#049fe1]">London Gateway?</span></h3>
                <p className="text-slate-400 text-lg leading-relaxed ">
                Our local expertise ensures your goods move through the port efficiently and compliantly. DP World London Gateway is one of the UK’s most modern and efficient ports, offering:
                </p>
              </div>
      ...
      <section className="py-24 bg-blue-100 relative overflow-hidden">
        ...
        <div className="max-w-5xl mx-auto px-6 relative z-10 text-center">
          ...
          <h2 className="text-4xl md:text-6xl font-bold text-slate-900 mb-6 tracking-tight">
            Get a Fast Quote for <br/> <span className="text-[#049fe1]">Customs Clearance at  London Gateway</span>
          </h2>
          ...
          Contact us today for expert customs clearance at London Gateway Port.
          </p>
