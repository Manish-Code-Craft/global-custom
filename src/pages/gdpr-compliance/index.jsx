        ...
        <Layout preview={preview}>
           ...
           backgroundImage="/images/service-bg.jpg"/>
             ...
             <div className="ens-declaration-uk-page-wrap">
                ...
                <div>
                <h2>The General Data Protection Regulation (GDPR) came into action on the 25th May, 2018.</h2>
                <p>This regulation has a significant impact on data privacy, and GLOBAL CUSTOM CLEARANCE LIMITED is committed to complying with all relevant aspects of the GDPR to keep your information safe and private</p>
                <p>We currently hold information on you and your clients, such as name, email address, and company details, to send you information about your consignments and also for invoicing purposes. Your client’s data is used for customs purposes only, as we are required by law to keep this for four years.</p>
                </div>
                <div>
                ...
                <div>
                <p>
                GLOBAL CUSTOM CLEARANCE LIMITED does not sell or share, for marketing purposes, our customers' email lists. However, we will share your contact information with third parties where it is necessary to do so by law, or where we need to administer our business.</p>
                <p>
                If you are happy for us to retain your information, no further action on your behalf is required.
                </p>
                <p>We very much value our working relationship and look forward to continuing to work with you.</p>
                </div>
                </div>
                </Container>
                </section>
