...
export default function Road ({ preview }) {
  ...
  const PageMeta = {
   title: "CDS Declarations | Custom Clearance Services UK",
  ...
  const cdsFaq = [
    ...
    return(
      ...
      <PageHead PageMeta={PageMeta} />
        ...
        <Heroroad bannerdescription='The UK’s Customs Declaration Service (CDS) is now the central platform for all import and export declarations. Whether you’re bringing goods into the UK or sending products overseas, every shipment must be declared correctly through CDS. Errors can lead to delays, rejected entries, additional charges, or goods being held at the border' title='CDS-Declarations' title2='CDS-Declarations' description="Global Customs provides fast, compliant CDS declarations for importers, exporters, freight forwarders, hauliers, manufacturers, and e-commerce businesses. Our team ensures your declarations are accurate, complete, and submitted on time — helping you avoid delays and keep your supply chain moving. This page explains how CDS works, what information you need, and why businesses across the UK trust Global Customs for reliable, expert customs filing."
